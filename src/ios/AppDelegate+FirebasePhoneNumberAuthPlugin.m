#import "AppDelegate+FirebasePhoneNumberAuthPlugin.h"
#import <objc/runtime.h>

static void swizzleMethod(Class class, SEL destinationSelector, SEL sourceSelector);

@implementation AppDelegate (FirebasePhoneNumberAuthPlugin)
...
- (BOOL)identity_application:(UIApplication *)app
    ...
    return [[UIApplication sharedInstance] handleURL:url
